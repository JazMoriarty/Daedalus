...
public:
    ...
    /// Open a floating thumbnail picker.  When the user clicks a material,
    /// cb is invoked with the UUID and the picker closes automatically.
    void openPicker(PickCallback cb);
