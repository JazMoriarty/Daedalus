...
// ─── CeilingShape ──────────────────────────────────────────────────────────────
// Controls how a sector's ceiling mesh is generated by the tessellator.

enum class CeilingShape : u32
{
    Flat        = 0,  ///< Flat (or per-vertex sloped) surface — default.
    Heightfield = 1,  ///< Terrain mesh from a HeightfieldFloor sample grid (inverted).
};
...
// ─── ArchProfile ───────────────────────────────────────────────────────────────
// Profile shape for DetailBrushType::ArchSpan.
...
// ─── DetailBrushType ───────────────────────────────────────────────────────────
// Identifies the procedural shape generated by a DetailBrush.

enum class DetailBrushType : u32
{
    Box          = 0,  ///< Axis-aligned box.  Parameters: halfExtents.
    Wedge        = 1,  ///< Triangular prism (one sloped face).  Parameters: halfExtents, slopeAxis.
    Cylinder     = 2,  ///< Faceted cylinder.  Parameters: radius, height, segmentCount.
    ArchSpan     = 3,  ///< Curved arch band.  Parameters: spanWidth, archHeight, thickness,
                       ///<   archProfile, archSegments.
    ImportedMesh = 4,  ///< Pre-compiled GLTF mesh.  Parameters: meshAssetId.
                       ///< The asset pipeline supplies the pre-baked MeshData at
                       ///< level-compile time; the tessellator skips this type.
};
